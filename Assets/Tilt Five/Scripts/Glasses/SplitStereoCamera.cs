...
namespace TiltFive
{
    ...
    {
        /// <summary> Param used to shift perceived depth </summary>
        public float depthPerceptionCorrection = -0.00233f;
        ...
        /// <summary> The MATERIAL assigned to dynamically SHIFT the camera used for rendering the left eye. </summary>
        private Material leftEyeShift;
        ...
        /// <summary> The MATERIAL assigned to dynamically SHIFT the camera used for rendering the right eye. </summary>
        private Material rightEyeShift;
        ...
        private void ConfigureEyeCameras()
        {
            ...
            leftEyeShift = new(Shader.Find("Hidden/T5/BlitShift"));
            ...
            rightEyeShift = new(Shader.Find("Hidden/T5/BlitShift"));
        }
        ...
        private void ApplyConstantShift()
        { 
            CommandBuffer buffer = new();

            leftEyeShift.SetFloat("_Shift", depthPerceptionCorrection);
            buffer.Blit(splitStereoTextures.LeftTexture_GLS, splitStereoTextures.LeftTexture_GLS, leftEyeShift);

            rightEyeShift.SetFloat("_Shift", -depthPerceptionCorrection);
            buffer.Blit(splitStereoTextures.RightTexture_GLS, splitStereoTextures.RightTexture_GLS, rightEyeShift);
